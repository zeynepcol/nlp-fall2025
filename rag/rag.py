...
print("OLLAMA RAW LIST:", ollama_models)  # debug için, istersen sonra sil
models = []

for m in ollama_models.get("models", []):
    # Bazı sürümlerde anahtar "name", bazılarında "model" / "model_name" olabiliyor
...
#   in one sentence, how many days did zeynep col live in new york?
#   which subway is the oldest ever?
#   which movie was zeynep featured in?
